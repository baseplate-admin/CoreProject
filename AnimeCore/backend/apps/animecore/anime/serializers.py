...
class AnimeInfoSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        recommendations = validated_data.pop("anime_recommendations", None)
        ...
        if producers:
            ...
            anime.anime_producers.set(items)
        ...
        if synonyms:
            ...
            anime.anime_name_synonyms.set(items)
        ...
        if recommendations:
            ...
            for item in recommendations:
                print(item)
                (
                    anime_recommendation_model,
                    _,
                ) = AnimeRecommendationModel.objects.get_or_create(
                    mal_url=item["mal_url"],
                    entry__mal_id__in=item["entry"]["mal_id"],
                )
                items.append(anime_recommendation_model)

            anime.anime_recommendations.set(items)
